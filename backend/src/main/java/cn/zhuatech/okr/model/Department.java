...
@Entity @Table(name="okr_department") public class Department extends BaseEntity {
    ...
    protected Department(){} public Department(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
